...
FICHES_API_BASE_URL = os.getenv("FICHES_API_BASE_URL", "").strip().rstrip("/")
...
GOOGLE_DRIVE_LABELS_FOLDER_ID = os.getenv("GOOGLE_DRIVE_LABELS_FOLDER_ID", "").strip() or GOOGLE_DRIVE_FOLDER_ID
GOOGLE_DRIVE_INVOICES_FOLDER_ID = os.getenv("GOOGLE_DRIVE_INVOICES_FOLDER_ID", "").strip()
GOOGLE_DRIVE_GOODS_RECEIPTS_FOLDER_ID = os.getenv("GOOGLE_DRIVE_GOODS_RECEIPTS_FOLDER_ID", "").strip()
GOOGLE_DRIVE_UPLOAD_FOLDER_ID = os.getenv("GOOGLE_DRIVE_UPLOAD_FOLDER_ID", "").strip() or GOOGLE_DRIVE_FOLDER_ID
...
DRIVE_IMPORT_WORKER_DOCUMENT_TYPES = [
    item.strip()
    for item in os.getenv("DRIVE_IMPORT_WORKER_DOCUMENT_TYPES", "").split(",")
    if item.strip()
]
if not DRIVE_IMPORT_WORKER_DOCUMENT_TYPES:
    DRIVE_IMPORT_WORKER_DOCUMENT_TYPES = [DRIVE_IMPORT_WORKER_DOCUMENT_TYPE]
DRIVE_IMPORT_WORKER_LIMIT = int(os.getenv("DRIVE_IMPORT_WORKER_LIMIT", "80"))
DRIVE_IMPORT_SCAN_LIMIT = int(os.getenv("DRIVE_IMPORT_SCAN_LIMIT", "2000"))
